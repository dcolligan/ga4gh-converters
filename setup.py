...
setup(
    name="ga4gh_converters",
    description="Converter library for the GA4GH API",
    packages=["ga4gh", "ga4gh.converters"],
    namespace_packages=["ga4gh"],
    url="https://github.com/ga4gh/ga4gh-converters",
    use_scm_version={"write_to": "ga4gh/converters/_version.py"},
    entry_points={
        'console_scripts': [
            'ga2vcf=ga4gh.converters.cli.ga2vcf:ga2vcf_main',
            'ga2sam=ga4gh.converters.cli.ga2sam:ga2sam_main',
        ]
    },
